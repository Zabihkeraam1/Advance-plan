    ...
    code_repository {
      ...
      code_configuration {
        ...
        code_configuration_values {
          ...
          # start_command = "source ./venv/bin/activate && python3 -m uvicorn backend.main:app --host 0.0.0.0 --port $PORT"
          start_command = "bash -c 'source ./venv/bin/activate && python3 -m uvicorn backend.main:app --host 0.0.0.0 --port $PORT'"
